...
if __name__ == "__main__":
    print("=" * 80)
    print("PORTFOLIO SIMULATION ON TEST SET")
    print("=" * 80)
    ...
    print("\nLoading pre-computed test dataset...")
    ...
    # Simulate portfolio performance on test period
    print("\nSimulating portfolio performance...")
    stats = portfolio.simulate(test_start, test_end)
